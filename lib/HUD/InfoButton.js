...
class InfoButton extends (THREE.Object3D) {
  ...
  _updateMesh() {
    ...
    if (this._isVR) {
      ...
      this._meshX = (this._viewWidth / 2) - (0.057 * this._viewHeight) - (this._meshWidth * this._scale * 0.5);
  ...
  updateActive(isActive) {
    if (this._isVisible && this._isHovered && this._rayIsActive && !isActive) {
      ...
      if (this._isTutorialShown) {
        this._isTutorialShown = false;
        this._app.emitter.emit('hideTutorial');
      } else {
        this._isTutorialShown = true;
        this._app.emitter.emit('showTutorial');
      }
    }
  ...
  draw() {
    ...
    // draw "i" bars
      ...
      this._ctx.beginPath();
      this._ctx.moveTo(this._contentX + (this._contentWidth / 2), this._contentY + 9);
      this._ctx.lineTo(this._contentX + (this._contentWidth / 2), this._contentY + 11);
      this._ctx.stroke();

      this._ctx.beginPath();
      this._ctx.moveTo(this._contentX + (this._contentWidth / 2), this._contentY + 13);
      this._ctx.lineTo(this._contentX + (this._contentWidth / 2), this._contentY + 21);
      this._ctx.stroke();
    } else {
      // draw "x" bars
      ...
      this._ctx.beginPath();
      this._ctx.moveTo(this._contentX + 10, this._contentY + 10);
      this._ctx.lineTo(this._contentX + 20, this._contentY + 20);
      this._ctx.stroke();

      this._ctx.beginPath();
      this._ctx.moveTo(this._contentX + 20, this._contentY + 10);
      this._ctx.lineTo(this._contentX + 10, this._contentY + 20);
      this._ctx.stroke();
    }
